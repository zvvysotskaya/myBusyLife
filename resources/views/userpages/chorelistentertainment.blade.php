  ...
  <div class="container-fluid">
      ...
      <div class="col-lg-12 col12create">
          <div class="container">
              ...
              <form method="POST" action="/userpages.chorelistentertainment" class="mytodolist">
                  {{csrf_field()}}
          ...
          <div class="container">
              <table class="table table-striped table-responsive">
                  ...
                  <tbody>
                      <th>{{$mytodo->task}}</th>
                      <th>{{$mytodo->description}}</th>
                      <th>
                          <form method="GET" action="/userpages/{{ $mytodo->id }}/updatemytodo">
                              <input type="submit" class="btn btn-primary" value="Update">
                          </form>
                      </th>
                      <th>
                          <form method="GET" action="/userpages/{{ $mytodo->id }}/deletemytodo">
              ...
              <div class="text-center">
                  <form method="POST" action="{{ url('userpages/chorelistentertainment') }}">
                      @method('DELETE')
                      {{ csrf_field() }}
