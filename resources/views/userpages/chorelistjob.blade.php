...
@section('title', 'job')
  ...
  <h1 class="mb-lg-4 mb-md-2 mb-0">Create / Manage Work Day To Do List</h1>
  @Auth
  ...
  <div class="container-fluid">
      ...
      <div class="col-lg-12 col12create">
          <div class="container">
              ...
              <form method="POST" action="/userpages.chorelistjob" class="mytodolist">
                  {{csrf_field()}}
          ...
          <div class="container">
              <table class="table table-striped table-responsive">
                  ...
                  <tbody>
                      <th>{{$worktodo->task}}</th>
                      <th>{{$worktodo->description}}</th>
                      <th>
                          <form method="GET" action="/userpages/{{ $worktodo->id }}/updateworktodo">
                              <input type="submit" class="btn btn-primary" value="Update">
                          </form>
                      </th>
                      <th>
                          <form method="GET" action="/userpages/{{ $worktodo->id }}/deleteworktodo">
              ...
              <div class="text-center">
                  <form method="POST" action="{{ url('userpages/chorelistjob') }}">
                      @method('DELETE')
                      {{ csrf_field() }}
